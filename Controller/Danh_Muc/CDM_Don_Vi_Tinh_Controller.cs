...
namespace Controller.Danh_Muc
{
    public class CDM_Don_Vi_Tinh_Controller
    {
        ...
        public async Task<List<CDM_Don_Vi_Tinh>> List_DM_Don_Vi_Tinh()
        {
            ...
            try
            {
                ...
                foreach (DataRow v_row in v_dt.Rows)
                {
                    ...
                    CDM_Don_Vi_Tinh v_objRes = CUtility.Map<CDM_Don_Vi_Tinh>(v_row);
        ...
        public CDM_Don_Vi_Tinh Get_DM_Don_Vi_Tinh_By_ID(int p_iID)
        {
            ...
            try
            {
                ...
                if (v_dt.Rows.Count > 0)
                {
                    ...
                    v_objRes = CUtility.Map<CDM_Don_Vi_Tinh>(v_dt.Rows[0]);
                }
            }
